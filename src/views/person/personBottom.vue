    ...
    <div class="item-button">
        ...
        <div class="content">
            <div class="content-wrapper">
                ...
                <div class="content-inner" v-for="(item, index) in questionList" :key="item.id"
                    :style="{ background: (index & 1) ? '#ffffff' : '#F7F7F8' }">
                    <el-skeleton :loading="loading" animated>
                        <template #template>
                        ...
                        <template #default>
                            <div class="content-title" @click="getSubmitContentFn(item.id)">{{ item.titleId + ". " +
                                item.titleName }}</div>

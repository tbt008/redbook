        ...
        <div class="footer">
          <div @click="clickFooter(0)" class="footer-container">
            <svg
              ...
              data-prefix="far"
              data-icon="thumbs-up"
              class="svg-inline--fa fa-thumbs-up absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
              <path
                :fill="clickToLike === true ? '#01B328' : '#939393'"
          ...
          <div @click="clickFooter(2)" class="footer-container">
            <svg
              ...
              data-prefix="far"
              data-icon="comment"
              class="svg-inline--fa fa-comment absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
          ...
          <div class="footer-other">
            <div
              @click="clickFooter(1)"
              :style="clickToFavour === false ? 'color: #939393' : 'color: #FFA116'"
            >
              <svg
                aria-hidden="true"
                focusable="false"
            ...
            <el-popover :width="150" trigger="click" popper-style="border-radius: 15px;">
              <template #reference>
                <svg
                  aria-hidden="true"
                  focusable="false"
                  ...
                  class="svg-inline--fa fa-arrow-up-right-from-square absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
                  ...
                  >
                    <div style="border-radius: 1000px; width: 30px; height: 30px">
                      <svg
                        ...
                        height="22"
                        fill="#00CA00"
                        class="ewspj560 css-1ocvhs9-Svg-SocialIcon ea8ky5j0"
                        data-v-2bc0a466=""
                      >
                        <path
                          fill-rule="evenodd"
                    ...
                    <div style="border-radius: 1000px; width: 30px; height: 30px">
                      <svg
                        ...
                        height="22"
                        fill="#4A9AFD"
                        class="ewspj560 css-1n5wd5l-Svg-SocialIcon ea8ky5j0"
                      >
                        <path
                          data-v-2bc0a466=""
                          fill-rule="evenodd"
                          d="M20.174 14.188a9.978 9.978 0 00-.63-1.166 7.274 7.274 0 00-.555-.768c-.335-.397-.663-.645-.949-.765.045-.37.067-.802.067-1.217 0-.957-.127-1.839-.337-2.484a6.196 6.196 0 00-6.192-5.77c-3.279 0-5.964 2.551-6.194 5.772-.212.647-.344 1.516-.344 2.484 0 .44.027.826.076 1.217-.281.159-.596.489-.913.886-.205.257-.41.558-.607.89-.167.284-.33.592-.48.92-.83 1.806-1.004 3.498-.388 3.782.39.18 1.006-.253 1.616-1.054a7.99 7.99 0 001.982 2.63c-.964.323-1.605.892-1.605 1.544 0 1.007 1.538.895 3.437.895 1.574 0 2.9.076 3.309-.47h.109c.053 0 .107 0 .16-.003.407.55 1.735.471 3.309.471 1.897 0 3.437.112 3.437-.895 0-.659-.656-1.234-1.643-1.556a7.98 7.98 0 002.02-2.732c.636.873 1.293 1.355 1.701 1.168.619-.28.445-1.974-.386-3.78z"
                          clip-rule="evenodd"
                        ></path>
                      </svg>
                    </div>
            ...
            <svg
              ...
              class="svg-inline--fa fa-circle-question absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
